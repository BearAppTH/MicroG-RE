...
public class CheckinService extends Service {
    ...
    static void schedule(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, TriggerReceiver.class.getName().hashCode(), new Intent(context, TriggerReceiver.class), PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
